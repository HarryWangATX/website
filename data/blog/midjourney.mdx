...
<EmblaCarousel slides={[
    ...
    {
        src: "/static/images/midjourneygenerated.png",
        alt: "RobotInSpaceMidjourneyImage"
    },
]} />


For those who are interested, the prompts are: `futuristic robot peaking into portal to another world, octane render, ultra detailed, cinematic lighting` and `surreal robot computer scientist in space`.
