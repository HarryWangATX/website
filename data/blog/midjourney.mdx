...
around with it for sometime and got to generate some awesome looking images, and I've included an image I generated from [Midjourney](https://www.midjourney.com/) below.

![Midjourney](/static/images/midjourneygenerated.png)

For those who are interested, the prompt is: `surreal robot computer scientist in space`.
